...
-   **Error koneksi database**\
    → Pastikan nama database sama persis dengan:

        muhammad_zhafran_amuri_xiipplg1_inventaris

-   **Halaman blank / putih**\
    → Aktifkan `display_errors` di `php.ini` atau cek ulang folder
    project.
...
## ✔️ Aplikasi Siap Digunakan

Anda sudah dapat menggunakan sistem inventaris sepenuhnya.
